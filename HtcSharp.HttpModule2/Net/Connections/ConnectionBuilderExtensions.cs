...
namespace HtcSharp.HttpModule2.Net.Connections
{
    public static class ConnectionBuilderExtensions
    {
        ...
        public static IConnectionBuilder Use(this IConnectionBuilder connectionBuilder, Func<Microsoft.AspNetCore.Connections.ConnectionContext, Func<Task>, Task> middleware)
        {
        ...
        public static IConnectionBuilder Run(this IConnectionBuilder connectionBuilder, Func<Microsoft.AspNetCore.Connections.ConnectionContext, Task> middleware)
        {
            return connectionBuilder.Use(next =>
            {
                return context =>
