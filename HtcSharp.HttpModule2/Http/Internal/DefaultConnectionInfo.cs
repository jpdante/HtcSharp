...
namespace HtcSharp.HttpModule2.Http.Internal
{
    internal sealed class DefaultConnectionInfo : ConnectionInfo
    {
        ...
        private readonly static Func<IFeatureCollection, ITlsConnectionFeature> _newTlsConnectionFeature = f => new Microsoft.AspNetCore.Http.Features.TlsConnectionFeature();
