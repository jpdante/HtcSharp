...
using HtcSharp.HttpModule2.Http.Headers;

namespace HtcSharp.HttpModule2.Http.Internal {
    internal sealed class DefaultHttpRequest : HttpRequest {
        ...
        private readonly Microsoft.AspNetCore.Http.DefaultHttpContext _context;
        private Features.FeatureReferences<FeatureInterfaces> _features;
