...
using HtcSharp.HttpModule2.Http.Abstractions;
using HtcSharp.HttpModule2.Http.Features;
using HtcSharp.HttpModule2.Infrastructure;
using HtcSharp.HttpModule2.Logging;
using HtcSharp.HttpModule2.Net.Connections.Exceptions;
using HtcSharp.HttpModule2.Primitives;
using HtcSharp.HttpModule2.Server;

namespace HtcSharp.HttpModule2.Http.Protocols.Http {
    internal abstract partial class HttpProtocol : HtcSharp.HttpModule2.Http.Protocols.Http.IHttpResponseControl {
        ...
        protected HtcSharp.HttpModule2.Http.Protocols.Http.RequestProcessingStatus _requestProcessingStatus;
        ...
        protected HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion _httpVersion;
        ...
        public HttpProtocol(HttpConnectionContext context) {
            ...
            HttpRequestHeaders = new HtcSharp.HttpModule2.Http.Protocols.Http.HttpRequestHeaders(reuseHeaderValues: !ServerOptions.DisableStringReuse);
            HttpResponseControl = this;
        }

        public HtcSharp.HttpModule2.Http.Protocols.Http.IHttpResponseControl HttpResponseControl { get; set; }
        ...
        public HtcSharp.HttpModule2.Http.Protocols.Http.IHttpOutputProducer Output { get; protected set; }

        protected IKestrelTrace Log => ServiceContext.Log;
        private HtcSharp.HttpModule2.Http.Protocols.Http.DateHeaderValueManager DateHeaderValueManager => ServiceContext.DateHeaderValueManager;
        ...
        public HtcSharp.HttpModule2.Http.Protocols.Http.HttpMethod Method { get; set; }
        ...
        public string HttpVersion {
            get {
                if (_httpVersion == HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion.Http11) {
                    return HttpUtilities.Http11Version;
                }
                if (_httpVersion == HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion.Http10) {
                    return HttpUtilities.Http10Version;
                }
                if (_httpVersion == HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion.Http2) {
            ...
            set {
                ...
                if (ReferenceEquals(value, HttpUtilities.Http11Version)) {
                    _httpVersion = HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion.Http11;
                } else if (ReferenceEquals(value, HttpUtilities.Http10Version)) {
                    _httpVersion = HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion.Http10;
                } else if (ReferenceEquals(value, HttpUtilities.Http2Version)) {
                    _httpVersion = HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion.Http2;
                } else {
        ...
        private void HttpVersionSetSlow(string value) {
            if (value == HttpUtilities.Http11Version) {
                ...
                _httpVersion = HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion.Unknown;
            }
        }
        ...
        public HtcSharp.HttpModule2.Http.Protocols.Http.HttpResponseTrailers ResponseTrailers { get; set; }
        ...
        public bool HasResponseStarted => _requestProcessingStatus >= HtcSharp.HttpModule2.Http.Protocols.Http.RequestProcessingStatus.HeadersCommitted;

        public bool HasFlushedHeaders => _requestProcessingStatus >= HtcSharp.HttpModule2.Http.Protocols.Http.RequestProcessingStatus.HeadersFlushed;

        public bool HasResponseCompleted => _requestProcessingStatus == HtcSharp.HttpModule2.Http.Protocols.Http.RequestProcessingStatus.ResponseCompleted;

        protected HtcSharp.HttpModule2.Http.Protocols.Http.HttpRequestHeaders HttpRequestHeaders { get; }

        protected HtcSharp.HttpModule2.Http.Protocols.Http.HttpResponseHeaders HttpResponseHeaders { get; } = new HtcSharp.HttpModule2.Http.Protocols.Http.HttpResponseHeaders();

        public void InitializeBodyControl(HtcSharp.HttpModule2.Http.Protocols.Http.MessageBody messageBody) {
        ...
        internal void ResetState() {
            _requestProcessingStatus = HtcSharp.HttpModule2.Http.Protocols.Http.RequestProcessingStatus.RequestPending;
        }
        ...
        public void Reset() {
            ...
            Method = HtcSharp.HttpModule2.Http.Protocols.Http.HttpMethod.None;
            _methodText = null;
            _endpoint = null;
            PathBase = null;
            Path = null;
        ...
        protected abstract HtcSharp.HttpModule2.Http.Protocols.Http.MessageBody CreateMessageBody();
        ...
        protected void AbortRequest() {
            ...
            if (shouldScheduleCancellation) {
                ...
                ServiceContext.Scheduler.Schedule(state => ((HtcSharp.HttpModule2.Http.Protocols.Http.HttpProtocol)state).CancelRequestAbortedToken(), this);
            }
        }
        ...
        public void OnHeader(Span<byte> name, Span<byte> value) {
            ...
            if (_requestHeadersParsed > ServerOptions.Limits.MaxRequestHeaderCount) {
                BadHttpRequestException.Throw(HtcSharp.HttpModule2.Http.Protocols.Http.RequestRejectionReason.TooManyHeaders);
            }
        ...
        public async Task ProcessRequestsAsync<TContext>(IHttpApplication<TContext> application) {
            try {
                ...
                if (_requestProcessingStatus != HtcSharp.HttpModule2.Http.Protocols.Http.RequestProcessingStatus.RequestPending) {
        ...
        protected bool VerifyResponseContentLength(out Exception ex) {
            ...
            if (Method != HtcSharp.HttpModule2.Http.Protocols.Http.HttpMethod.Head &&
        ...
        private HtcSharp.HttpModule2.Http.Protocols.Http.HttpResponseHeaders InitializeResponseFirstWrite(int firstWriteByteCount) {
            VerifyInitializeState(firstWriteByteCount);
            ...
            _requestProcessingStatus = HtcSharp.HttpModule2.Http.Protocols.Http.RequestProcessingStatus.HeadersFlushed;
        ...
        private void ProduceStart(bool appCompleted) {
            ...
            _requestProcessingStatus = HtcSharp.HttpModule2.Http.Protocols.Http.RequestProcessingStatus.HeadersCommitted;
        ...
        private Task WriteSuffix() {
            if (_autoChunk || _httpVersion == HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion.Http2) {
            ...
            _requestProcessingStatus = HtcSharp.HttpModule2.Http.Protocols.Http.RequestProcessingStatus.ResponseCompleted;

            if (_keepAlive) {
                Log.ConnectionKeepAlive(ConnectionId);
            }

            if (Method == HtcSharp.HttpModule2.Http.Protocols.Http.HttpMethod.Head && _responseBytesWritten > 0) {
        ...
        private HtcSharp.HttpModule2.Http.Protocols.Http.HttpResponseHeaders CreateResponseHeaders(bool appCompleted) {
            var responseHeaders = HttpResponseHeaders;
            var hasConnection = responseHeaders.HasConnection;
            var connectionOptions = HttpHeaders.ParseConnection(responseHeaders.HeaderConnection);
            var hasTransferEncoding = responseHeaders.HasTransferEncoding;

            if (_keepAlive && hasConnection && (connectionOptions & HtcSharp.HttpModule2.Http.Protocols.Http.ConnectionOptions.KeepAlive) != HtcSharp.HttpModule2.Http.Protocols.Http.ConnectionOptions.KeepAlive) {
                _keepAlive = false;
            }
            ...
            if (hasTransferEncoding &&
                HttpHeaders.GetFinalTransferCoding(responseHeaders.HeaderTransferEncoding) != HtcSharp.HttpModule2.Http.Protocols.Http.TransferCoding.Chunked) {
                _keepAlive = false;
            }
            ...
            if (!_canWriteResponseBody && hasTransferEncoding) {
                ...
                if (StatusCode == StatusCodes.Status101SwitchingProtocols) {
                  ...
                  else if (_httpVersion == HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion.Http11) {
                    _autoChunk = true;
            ...
            if (!hasConnection && _httpVersion != HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion.Http2) {
                if (!_keepAlive) {
                    responseHeaders.SetRawConnection("close", _bytesConnectionClose);
                } else if (_httpVersion == HtcSharp.HttpModule2.Http.Protocols.Http.HttpVersion.Http10) {
        ...
        private bool CanWriteResponseBody() {
            ...
            return Method != HtcSharp.HttpModule2.Http.Protocols.Http.HttpMethod.Head &&
        ...
        private void RejectNonBodyTransferEncodingResponse(bool appCompleted) {
            ...
            if (!appCompleted) {
                ...
                _requestProcessingStatus = HtcSharp.HttpModule2.Http.Protocols.Http.RequestProcessingStatus.AppStarted;
                throw ex;
            } else {
                ReportApplicationError(ex);
        ...
        private BadHttpRequestException GetInvalidRequestTargetException(Span<byte> target)
            => BadHttpRequestException.GetException(
                HtcSharp.HttpModule2.Http.Protocols.Http.RequestRejectionReason.InvalidRequestTarget,
