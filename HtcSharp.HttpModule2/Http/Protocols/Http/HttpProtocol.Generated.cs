...
using IEndpointFeature = HtcSharp.HttpModule2.Http.Abstractions.IEndpointFeature;
using IHttp2StreamIdFeature = HtcSharp.HttpModule2.Server.Features.IHttp2StreamIdFeature;
using IHttpAuthenticationFeature = HtcSharp.HttpModule2.Http.Features.Authentication.IHttpAuthenticationFeature;
using IHttpMinRequestBodyDataRateFeature = HtcSharp.HttpModule2.Server.Features.IHttpMinRequestBodyDataRateFeature;
using IHttpMinResponseDataRateFeature = HtcSharp.HttpModule2.Server.Features.IHttpMinResponseDataRateFeature;
using IRouteValuesFeature = HtcSharp.HttpModule2.Http.Abstractions.IRouteValuesFeature;
