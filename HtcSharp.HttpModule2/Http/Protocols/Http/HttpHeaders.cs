...
namespace HtcSharp.HttpModule2.Http.Protocols.Http {
    internal abstract class HttpHeaders : IHeaderDictionary {
        ...
        public static unsafe HtcSharp.HttpModule2.Http.Protocols.Http.ConnectionOptions ParseConnection(StringValues connection) {
            var connectionOptions = HtcSharp.HttpModule2.Http.Protocols.Http.ConnectionOptions.None;
                        ...
                        if (tokenLength >= 9 && (*ch | 0x20) == 'k') {
                            if ((*++ch | 0x20) == 'e' &&
                                ...
                                *++ch == '-' &&
                                ...
                                if (ch == tokenEnd) {
                                    connectionOptions |= HtcSharp.HttpModule2.Http.Protocols.Http.ConnectionOptions.KeepAlive;
                                }
                            }
                            ...
                            if ((*++ch | 0x20) == 'p' &&
                                ...
                                if (ch == tokenEnd) {
                                    connectionOptions |= HtcSharp.HttpModule2.Http.Protocols.Http.ConnectionOptions.Upgrade;
                                }
                            }
                            ...
                            if ((*++ch | 0x20) == 'l' &&
                                ...
                                if (ch == tokenEnd) {
                                    connectionOptions |= HtcSharp.HttpModule2.Http.Protocols.Http.ConnectionOptions.Close;
                                }
                            }
                        }
        ...
        public static unsafe HtcSharp.HttpModule2.Http.Protocols.Http.TransferCoding GetFinalTransferCoding(StringValues transferEncoding) {
            var transferEncodingOptions = HtcSharp.HttpModule2.Http.Protocols.Http.TransferCoding.None;
                    ...
                    while (ch < end) {
                        ...
                        if (tokenLength >= 7 && (*ch | 0x20) == 'c') {
                            if ((*++ch | 0x20) == 'h' &&
                                ...
                                if (ch == tokenEnd) {
                                    transferEncodingOptions = HtcSharp.HttpModule2.Http.Protocols.Http.TransferCoding.Chunked;
                                }
                            }
                        }

                        if (tokenLength > 0 && ch != tokenEnd) {
                            transferEncodingOptions = HtcSharp.HttpModule2.Http.Protocols.Http.TransferCoding.Other;
                        }
