...
using HtcSharp.HttpModule2.Http.Protocols.Http;
using HtcSharp.HttpModule2.Http.Protocols.Http2.FlowControl;
using HtcSharp.HttpModule2.Http.Protocols.Http2.HPack;
...
using BadHttpRequestException = HtcSharp.HttpModule2.Server.BadHttpRequestException;
using HeaderNames = HtcSharp.HttpModule2.Http.Headers.HeaderNames;
using IKestrelTrace = HtcSharp.HttpModule2.Infrastructure.IKestrelTrace;
using ISystemClock = HtcSharp.HttpModule2.Infrastructure.ISystemClock;
using ITimeoutControl = HtcSharp.HttpModule2.Infrastructure.ITimeoutControl;
using KestrelServerLimits = HtcSharp.HttpModule2.Server.KestrelServerLimits;
using TimeoutReason = HtcSharp.HttpModule2.Infrastructure.TimeoutReason;
