...
namespace HtcSharp.HttpModule2.Http.Features
{
    public class FormFeature : Microsoft.AspNetCore.Http.Features.IFormFeature
    {
        ...
        private Task<Microsoft.AspNetCore.Http.IFormCollection> _parsedFormTask;
        private Microsoft.AspNetCore.Http.IFormCollection _form;
        ...
        public Microsoft.AspNetCore.Http.IFormCollection Form
        {
            get { return _form; }
            set
            {
        ...
        public Task<Microsoft.AspNetCore.Http.IFormCollection> ReadFormAsync() => ReadFormAsync(CancellationToken.None);

        public Task<Microsoft.AspNetCore.Http.IFormCollection> ReadFormAsync(CancellationToken cancellationToken)
        {
        ...
        private async Task<Microsoft.AspNetCore.Http.IFormCollection> InnerReadFormAsync(CancellationToken cancellationToken)
        {
            if (!HasFormContentType)
            {
                throw new InvalidOperationException("Incorrect Content-Type: " + _request.ContentType);
            ...
            {
                return Microsoft.AspNetCore.Http.FormCollection.Empty;
            }
            ...
            Microsoft.AspNetCore.Http.FormCollection formFields = null;
            ...
            using (cancellationToken.Register((state) => ((HttpContext)state).Abort(), _request.HttpContext))
            {
                ...
                if (HasApplicationFormContentType(contentType))
                {
                    ...
                    formFields = new Microsoft.AspNetCore.Http.FormCollection(await formReader.ReadFormAsync(cancellationToken));
                }
                else if (HasMultipartFormContentType(contentType))
                {
                    ...
                    while (section != null)
                    {
                        ...
                        if (contentDisposition.IsFileDisposition())
                        {
                            ...
                            file.Headers = new Microsoft.AspNetCore.Http.HeaderDictionary(section.Headers);
                    ...
                    {
                        formFields = new Microsoft.AspNetCore.Http.FormCollection(formAccumulator.GetResults(), files);
                    }
                }
            }
            ...
            {
                Form = new Microsoft.AspNetCore.Http.FormCollection(null, files);
            }
            else
            {
                Form = Microsoft.AspNetCore.Http.FormCollection.Empty;
            }
