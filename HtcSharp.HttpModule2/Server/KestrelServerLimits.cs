...
namespace HtcSharp.HttpModule2.Server
{
    public class KestrelServerLimits
    {
        ...
        /// This limit has no effect on upgraded connections which are always unlimited.
        /// This can be overridden per-request via <see cref="Features.IHttpMinRequestBodyDataRateFeature"/>.
        ...
        /// Setting this property to null indicates no minimum data rate should be enforced.
        /// This limit has no effect on upgraded connections which are always unlimited.
        /// This can be overridden per-request via <see cref="Features.IHttpMinResponseDataRateFeature"/>.
        /// <para>
        /// Defaults to 240 bytes/second with a 5 second grace period.
        /// </para>
        /// </summary>
