...
using HtcSharp.HttpModule2.Http;
...
using HtcSharp.HttpModule2.Middleware;
using HtcSharp.HttpModule2.Net.Connections;
using HtcSharp.HttpModule2.Options;

namespace HtcSharp.HttpModule2.Server {
