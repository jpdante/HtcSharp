...
using ConnectionDelegate = HtcSharp.HttpModule2.Net.Connections.ConnectionDelegate;
using ConnectionLogScope = HtcSharp.HttpModule2.Http.ConnectionLogScope;
using ServiceContext = HtcSharp.HttpModule2.Http.ServiceContext;
