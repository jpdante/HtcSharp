...
elseif args[2] == "Release" then
	...
	File.copy(Path.combine(args[3], [[Plugins/HtcPlugin.Lua.MyProcessorSQL/bin/Release]], "MoonSharp.Interpreter.dll"), Path.combine(args[3], [[HtcSharp.Server/bin/Release/plugins]], "MoonSharp.Interpreter.dll"), true)
end
