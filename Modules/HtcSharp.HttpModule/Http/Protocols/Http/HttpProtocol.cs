...
namespace HtcSharp.HttpModule.Http.Protocols.Http {
    internal abstract partial class HttpProtocol : IHttpResponseControl {
        ...
        public HttpProtocol(HttpConnectionContext context) {
            ...
            HttpRequestHeaders = new HtcSharp.HttpModule.Http.Protocols.Http.HttpRequestHeaders(reuseHeaderValues: !ServerOptions.DisableStringReuse);
        ...
        public string HttpVersion {
            ...
            set {
                ...
                if (ReferenceEquals(value, HttpUtilities.Http11Version)) {
                    _httpVersion = HtcSharp.HttpModule.Http.Protocols.Http.HttpVersion.Http11;
                } else if (ReferenceEquals(value, HttpUtilities.Http10Version)) {
                    _httpVersion = HtcSharp.HttpModule.Http.Protocols.Http.HttpVersion.Http10;
                } else if (ReferenceEquals(value, HttpUtilities.Http2Version)) {
                    _httpVersion = HtcSharp.HttpModule.Http.Protocols.Http.HttpVersion.Http2;
                } else {
        ...
        private void HttpVersionSetSlow(string value) {
            if (value == HttpUtilities.Http11Version) {
                ...
                _httpVersion = HtcSharp.HttpModule.Http.Protocols.Http.HttpVersion.Unknown;
            }
        }
        ...
        protected HtcSharp.HttpModule.Http.Protocols.Http.HttpRequestHeaders HttpRequestHeaders { get; }

        protected HtcSharp.HttpModule.Http.Protocols.Http.HttpResponseHeaders HttpResponseHeaders { get; } = new HtcSharp.HttpModule.Http.Protocols.Http.HttpResponseHeaders();
        ...
        public void ProduceContinue() {
            ...
            if (_httpVersion != HtcSharp.HttpModule.Http.Protocols.Http.HttpVersion.Http10 &&
        ...
        private HtcSharp.HttpModule.Http.Protocols.Http.HttpResponseHeaders InitializeResponseFirstWrite(int firstWriteByteCount) {
            VerifyInitializeState(firstWriteByteCount);
        ...
        private Task WriteSuffix() {
            if (_autoChunk || _httpVersion == HtcSharp.HttpModule.Http.Protocols.Http.HttpVersion.Http2) {
        ...
        private HtcSharp.HttpModule.Http.Protocols.Http.HttpResponseHeaders CreateResponseHeaders(bool appCompleted) {
            var responseHeaders = HttpResponseHeaders;
            ...
            if (!hasConnection && _httpVersion != HtcSharp.HttpModule.Http.Protocols.Http.HttpVersion.Http2) {
                if (!_keepAlive) {
                    responseHeaders.SetRawConnection("close", _bytesConnectionClose);
                } else if (_httpVersion == HtcSharp.HttpModule.Http.Protocols.Http.HttpVersion.Http10) {
