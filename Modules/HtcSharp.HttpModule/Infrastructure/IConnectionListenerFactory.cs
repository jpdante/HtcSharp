...
namespace HtcSharp.HttpModule.Infrastructure {
    ...
    public interface IConnectionListenerFactory {
        ...
        /// <returns>A <see cref="ValueTask"/> that completes when the listener has been bound, yielding a <see cref="IConnectionListener" /> representing the new listener.</returns>
