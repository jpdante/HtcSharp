...
using HttpHeaders = HtcSharp.HttpModule.Core.Http.Http.HttpHeaders;
        ...
        public static MessageBody For(
            ...
            if (headers.HasTransferEncoding) {
                ...
                if (transferCoding != TransferCoding.Chunked) {
                    BadHttpRequestException.Throw((RequestRejectionReason) RequestRejectionReason.FinalTransferCodingNotChunked, (StringValues) transferEncoding);
                }
            ...
            if (context.Method == HttpMethod.Post || context.Method == HttpMethod.Put) {
                ...
                BadHttpRequestException.Throw(requestRejectionReason, (HttpMethod) context.Method);
            }
