...
using HtcSharp.HttpModule.Infrastructure.Exceptions;
...
using HttpVersion = HtcSharp.HttpModule.Infrastructure.Protocol.Http.HttpVersion;
...
namespace HtcSharp.HttpModule.Core.Http.Http {
    internal abstract partial class HttpProtocol : IHttpResponseControl {
        ...
        public HttpProtocol(HttpConnectionContext context) {
            ...
            HttpRequestHeaders = new HttpModule.Infrastructure.Protocol.Http.HttpRequestHeaders(reuseHeaderValues: !ServerOptions.DisableStringReuse);
        ...
        public string HttpVersion {
            get {
                if (_httpVersion == HttpModule.Infrastructure.Protocol.Http.HttpVersion.Http11) {
                    return HttpUtilities.Http11Version;
                }
                if (_httpVersion == HttpModule.Infrastructure.Protocol.Http.HttpVersion.Http10) {
                    return HttpUtilities.Http10Version;
                }
                if (_httpVersion == HttpModule.Infrastructure.Protocol.Http.HttpVersion.Http2) {
            ...
            set {
                ...
                if (ReferenceEquals(value, HttpUtilities.Http11Version)) {
                    _httpVersion = HttpModule.Infrastructure.Protocol.Http.HttpVersion.Http11;
                } else if (ReferenceEquals(value, HttpUtilities.Http10Version)) {
                    _httpVersion = HttpModule.Infrastructure.Protocol.Http.HttpVersion.Http10;
                } else if (ReferenceEquals(value, HttpUtilities.Http2Version)) {
                    _httpVersion = HttpModule.Infrastructure.Protocol.Http.HttpVersion.Http2;
                } else {
        ...
        private void HttpVersionSetSlow(string value) {
            if (value == HttpUtilities.Http11Version) {
                ...
                _httpVersion = HttpModule.Infrastructure.Protocol.Http.HttpVersion.Unknown;
            }
        }
        ...
        public HttpModule.Infrastructure.Protocol.Http.HttpResponseTrailers ResponseTrailers { get; set; }
        ...
        protected HttpModule.Infrastructure.Protocol.Http.HttpRequestHeaders HttpRequestHeaders { get; }

        protected HttpModule.Infrastructure.Protocol.Http.HttpResponseHeaders HttpResponseHeaders { get; } = new HttpModule.Infrastructure.Protocol.Http.HttpResponseHeaders();
        ...
        protected void AbortRequest() {
            ...
            if (shouldScheduleCancellation) {
                ...
                ServiceContext.Scheduler.Schedule(state => ((HttpModule.Infrastructure.Protocol.Http.HttpProtocol)state).CancelRequestAbortedToken(), this);
            }
        }
        ...
        private HttpModule.Infrastructure.Protocol.Http.HttpResponseHeaders InitializeResponseFirstWrite(int firstWriteByteCount) {
            VerifyInitializeState(firstWriteByteCount);
        ...
        private Task WriteSuffix() {
            if (_autoChunk || _httpVersion == HttpModule.Infrastructure.Protocol.Http.HttpVersion.Http2) {
        ...
        private HttpModule.Infrastructure.Protocol.Http.HttpResponseHeaders CreateResponseHeaders(bool appCompleted) {
            var responseHeaders = HttpResponseHeaders;
            ...
            if (!_canWriteResponseBody && hasTransferEncoding) {
                ...
                if (StatusCode == StatusCodes.Status101SwitchingProtocols) {
                  ...
                  else if (_httpVersion == HttpModule.Infrastructure.Protocol.Http.HttpVersion.Http11) {
                    _autoChunk = true;
            ...
            if (!hasConnection && _httpVersion != HttpModule.Infrastructure.Protocol.Http.HttpVersion.Http2) {
                if (!_keepAlive) {
                    responseHeaders.SetRawConnection("close", _bytesConnectionClose);
                } else if (_httpVersion == HttpModule.Infrastructure.Protocol.Http.HttpVersion.Http10) {
