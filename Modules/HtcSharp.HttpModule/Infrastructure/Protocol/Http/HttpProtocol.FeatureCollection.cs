        ...
        PipeReader IRequestBodyPipeFeature.Reader {
            get {
                if (!ReferenceEquals(_requestStreamInternal, RequestBody)) {
                    ...
                    RequestBodyPipeReader = PipeReader.Create(RequestBody, new StreamPipeReaderOptions(_context.MemoryPool, MemoryPoolExtensions.GetMinimumSegmentSize(_context.MemoryPool), MemoryPoolExtensions.GetMinimumAllocSize(_context.MemoryPool)));
