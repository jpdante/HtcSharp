...
using HtcSharp.HttpModule.Infrastructure.IO;
using HtcSharp.HttpModule.Infrastructure.PipeWriterHelpers;
using IHttpMinResponseDataRateFeature = HtcSharp.HttpModule.Infrastructure.Protocol.Features.IHttpMinResponseDataRateFeature;
