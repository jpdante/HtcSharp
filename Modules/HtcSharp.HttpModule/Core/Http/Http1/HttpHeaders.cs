...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Internal.Http
{
    internal abstract class HttpHeaders : IHeaderDictionary
    {
        ...
        public static unsafe HtcSharp.HttpModule.Core.Http.Http1.ConnectionOptions ParseConnection(StringValues connection)
        {
            var connectionOptions = HtcSharp.HttpModule.Core.Http.Http1.ConnectionOptions.None;
                    ...
                    while (ch < end)
                    {
                        ...
                        if (tokenLength >= 9 && (*ch | 0x20) == 'k')
                        {
                                ...
                                (*++ch | 0x20) == 'e')
                            {
                                ...
                                if (ch == tokenEnd)
                                {
                                    connectionOptions |= HtcSharp.HttpModule.Core.Http.Http1.ConnectionOptions.KeepAlive;
                                }
                            }
                        }
                        else if (tokenLength >= 7 && (*ch | 0x20) == 'u')
                        {
                                ...
                                (*++ch | 0x20) == 'e')
                            {
                                ...
                                if (ch == tokenEnd)
                                {
                                    connectionOptions |= HtcSharp.HttpModule.Core.Http.Http1.ConnectionOptions.Upgrade;
                                }
                            }
                        }
                        else if (tokenLength >= 5 && (*ch | 0x20) == 'c')
                        {
                                ...
                                (*++ch | 0x20) == 'e')
                            {
                                ...
                                if (ch == tokenEnd)
                                {
                                    connectionOptions |= HtcSharp.HttpModule.Core.Http.Http1.ConnectionOptions.Close;
                                }
                            }
                        }
        ...
        public static unsafe HtcSharp.HttpModule.Core.Http.Http1.TransferCoding GetFinalTransferCoding(StringValues transferEncoding)
        {
            var transferEncodingOptions = HtcSharp.HttpModule.Core.Http.Http1.TransferCoding.None;
                    ...
                    while (ch < end)
                    {
                        ...
                        if (tokenLength >= 7 && (*ch | 0x20) == 'c')
                        {
                                ...
                                (*++ch | 0x20) == 'd')
                            {
                                ...
                                if (ch == tokenEnd)
                                {
                                    transferEncodingOptions = HtcSharp.HttpModule.Core.Http.Http1.TransferCoding.Chunked;
                                }
                            }
                        }
                        ...
                        {
                            transferEncodingOptions = HtcSharp.HttpModule.Core.Http.Http1.TransferCoding.Other;
                        }
