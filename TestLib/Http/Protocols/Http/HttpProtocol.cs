...
using TestLib.Http.Abstractions.Routing;
...
namespace TestLib.Http.Protocols.Http {
    internal abstract partial class HttpProtocol : IHttpResponseControl {
        ...
        public HttpProtocol(HttpConnectionContext context) {
            ...
            HttpRequestHeaders = new TestLib.Http.Protocols.Http.HttpRequestHeaders(reuseHeaderValues: !ServerOptions.DisableStringReuse);
        ...
        public string HttpVersion {
            ...
            set {
                ...
                if (ReferenceEquals(value, HttpUtilities.Http11Version)) {
                    _httpVersion = TestLib.Http.Protocols.Http.HttpVersion.Http11;
                } else if (ReferenceEquals(value, HttpUtilities.Http10Version)) {
                    _httpVersion = TestLib.Http.Protocols.Http.HttpVersion.Http10;
                } else if (ReferenceEquals(value, HttpUtilities.Http2Version)) {
                    _httpVersion = TestLib.Http.Protocols.Http.HttpVersion.Http2;
                } else {
        ...
        private void HttpVersionSetSlow(string value) {
            if (value == HttpUtilities.Http11Version) {
                ...
                _httpVersion = TestLib.Http.Protocols.Http.HttpVersion.Unknown;
            }
        }
        ...
        public TestLib.Http.Protocols.Http.HttpResponseTrailers ResponseTrailers { get; set; }
        ...
        protected TestLib.Http.Protocols.Http.HttpRequestHeaders HttpRequestHeaders { get; }

        protected TestLib.Http.Protocols.Http.HttpResponseHeaders HttpResponseHeaders { get; } = new TestLib.Http.Protocols.Http.HttpResponseHeaders();
        ...
        protected void AbortRequest() {
            ...
            if (shouldScheduleCancellation) {
                ...
                ServiceContext.Scheduler.Schedule(state => ((TestLib.Http.Protocols.Http.HttpProtocol)state).CancelRequestAbortedToken(), this);
            }
        }
        ...
        public void ProduceContinue() {
            ...
            if (_httpVersion != TestLib.Http.Protocols.Http.HttpVersion.Http10 &&
        ...
        private TestLib.Http.Protocols.Http.HttpResponseHeaders InitializeResponseFirstWrite(int firstWriteByteCount) {
            VerifyInitializeState(firstWriteByteCount);
        ...
        private Task WriteSuffix() {
            if (_autoChunk || _httpVersion == TestLib.Http.Protocols.Http.HttpVersion.Http2) {
        ...
        private TestLib.Http.Protocols.Http.HttpResponseHeaders CreateResponseHeaders(bool appCompleted) {
            var responseHeaders = HttpResponseHeaders;
            ...
            if (!_canWriteResponseBody && hasTransferEncoding) {
                ...
                if (StatusCode == StatusCodes.Status101SwitchingProtocols) {
                  ...
                  else if (_httpVersion == TestLib.Http.Protocols.Http.HttpVersion.Http11) {
                    _autoChunk = true;
            ...
            if (!hasConnection && _httpVersion != TestLib.Http.Protocols.Http.HttpVersion.Http2) {
                if (!_keepAlive) {
                    responseHeaders.SetRawConnection("close", _bytesConnectionClose);
                } else if (_httpVersion == TestLib.Http.Protocols.Http.HttpVersion.Http10) {
